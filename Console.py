...
#     retorno=mod.dar_departamento_con_mas_mediciones(info_matriz)
#     print("El departamento con más mediciones es {0}".format(retorno))
...
#     retorno=mod.contar_numero_de_mediciones_por_ica_dado(info_matriz, ica_a_buscar)
#     print("Hay {0} mediciones".format(retorno))
...
#     print("El departamento y el ICA con mayores mediciones es: {0} con {1}".format(t[0],t[1]))
